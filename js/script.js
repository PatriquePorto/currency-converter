...
const dataURL = "http://api.exchangeratesapi.io/v1/latest?access_key=345f66bc8c8fcfd7e26f1bda3697b430"




const initiallyDisplayedCurrencies = ["USD", "BRL", "EUR", "GBP", "CAD"]
let baseCurrency
    ...
    currenciesList.insertAdjacentHTML("beforeend",
     `  <li class="currency ${currency.abbreviation===baseCurrency ? "base-currency" : ""}" id=${currency.abbreviation}>
           <img src=${currency.flagURL} class="flag">
              <div class="info">
                <p class="input"><span class="currency-symbol">${currency.symbol}</span><input placeholder="0.0000" type="number" min="1" value=${inputValue}></p>
